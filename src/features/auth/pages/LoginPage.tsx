 ...
 * WHAT THIS FILE DOES : Renders an admin portal page
...
const LoginPage: React.FC = () => {
  ...
  const features = [
    ...
    { icon: <Clock className="w-4 h-4" />, text: "KYC and audit monitoring" },
    { icon: <BadgeDollarSign className="w-4 h-4" />, text: "Escrow controls" },
  ];
  ...
  return (
    <AuthLayout>
      <motion.div
        ...
        className="w-full max-w-5xl h-125 bg-white rounded-xl shadow-2xl overflow-hidden grid md:grid-cols-2 border border-gray-100"
      >
        {/* Left Side: Branding */}
        {/* <div className="relative hidden md:flex flex-col justify-between p-8 bg-gradient-to-br from-brand via-brand/90 to-pink-600 text-white overflow-hidden"> */}
        <div className="relative hidden md:flex flex-col justify-between p-8 bg-transparent text-gray-900 overflow-hidden">
          ...
          <div className="relative z-10">
            <Link to="/" className="inline-block mb-8">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center text-brand">
                  <img
                    src="./logo.svg"
                    alt="airb application logo"
                    className="flex-1"
                  />
                </div>
                <span className="text-xl text-brand">InkingiPro</span>
              </div>
            </Link>
            ...
            >
              InkingiPro Admin <br /> Control Center
            </motion.h1>
          ...
          <div className="relative z-10 pt-6 border-t border-black/20">
            <p
              className="text-blue-500 text-xs font-medium cursor-pointer hover: transition-all"
              onClick={() => navigate("/")}
            >
        ...
        <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center overflow-y-auto custom-scrollbar">
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label
                htmlFor="email"
                className="text-[14px]  text-black/80 ml-1"
              >
                Email Address
              </Label>
              <Input
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center px-1">
                ...
                <span className="text-[12px] text-gray-400">Admin only</span>
              </div>
            ...
            <Button
              type="submit"
              className="w-full py-3 rounded-lg text-xm font-black bg-brand hover:bg-brand/90 text-white mt-2 h-auto"
              isLoading={isLoading}
