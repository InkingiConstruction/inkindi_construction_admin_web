...
const AdminDashboardPreview: React.FC = () => (
  <div
    className="mt-8 w-full overflow-hidden rounded-xl border border-white/20 bg-white shadow-2xl shadow-black/20"
    aria-hidden="true"
  >
    <div className="flex min-h-[250px]">
      {/* Sidebar */}
      <div className="w-[74px] shrink-0 border-r border-gray-100 bg-gray-50 p-2">
