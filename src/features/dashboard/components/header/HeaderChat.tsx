  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        {totalUnread > 0 && (
          <span className="absolute top-1.5 right-1.5 min-w-[16px] h-4 bg-brand text-white text-[10px] font-bold rounded-full flex items-center justify-center px-1">
            ...
            {!selectedChat ? (
              ...
              <>
                    ...
                    conversations.map((conv) => (
                      ...
                      >
                        <div className="flex gap-3">
                          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-brand to-pink-500 flex items-center justify-center text-white font-semibold text-sm shrink-0">
                ...
                <Link to="/dashboard/messages">
                  <button className="w-full p-3 text-center text-sm text-brand font-medium hover:bg-gray-50 border-t border-gray-100">
                    View All Messages
                  </button>
                </Link>
              </>
              ...
              <>
                <div className="flex items-center gap-3 p-3 border-b border-gray-100 bg-gray-50">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-brand to-pink-500 flex items-center justify-center text-white font-semibold text-sm">
                ...
                <div className="p-3 border-t border-gray-100 flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand"
                  />
                  <button
                    onClick={handleSendMessage}
                    disabled={!messageInput.trim()}
                    className="p-2 rounded-xl bg-brand text-white hover:bg-brand-dark disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
                    <Send size={16} />
                  </button>
                </div>
