 ...
 * FILE HEADER COMMENT
 * ============================================================================
 * FILE NAME        : HeaderNotifications.tsx
...
import { Bell, DollarSign, ShieldCheck, MessageSquare } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { Link } from 'react-router-dom';
import { useInbox } from '../../../../contexts/InboxContext';
import type { AppNotification } from '../../../../contexts/InboxContext';
...
const getIcon = (type: string) => {
  switch(type) {
    case 'kyc': return <ShieldCheck size={14} className="text-brand" />;
    case 'message':
